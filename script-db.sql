...
INSERT INTO comentarios (data_postagem, texto, usuario, editado) VALUES
    (NOW(), 'Boa tarde João, poderia informar a data desejada para troca do equipamento na sede?', 'mariacardoso@gmail.com', false);